    ...
    2153: function (e, t, n) {
      ...
      n.r(t),
        n.d(t, {
          ...
          useRecoilState_TRANSITION_SUPPORT_UNSTABLE: function () {
            return i4;
          },
          ...
          useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE: function () {
            return i2;
          },
          useRecoilValue_TRANSITION_SUPPORT_UNSTABLE: function () {
            return i5;
          },
      ...
      function b(e) {
        var t;
        let n = (t = (
          Array.isArray(e) ? e : Object.getOwnPropertyNames(e).map((t) => e[t])
        ).map((e) => (w(e) ? e : f(e) ? R(e) : S(e)))).every(
          (e) => "hasValue" === e.state
        )
          ? S(t.map((e) => e.contents))
          : t.some((e) => "hasError" === e.state)
          ? g(
              h(
                t.find((e) => "hasError" === e.state),
                "Invalid loadable passed to loadableAll"
              ).contents
            )
          : R(Promise.all(t.map((e) => e.contents)));
        ...
        ((function (e, t) {
          ...
          if (null != o && "" !== o) {
            if (!["true", "false"].includes(o))
              throw d(
                `process.env.${e} value must be 'true', 'false', or empty: ${o}`
              );
            t("true" === o);
          }
      ...
      var k = function (e, t, { error: n } = {}) {
        return null;
      };
      let V =
          null !== (i = s.createMutableSource) && void 0 !== i
            ? i
            : s.unstable_createMutableSource,
        C =
          null !== (a = s.useMutableSource) && void 0 !== a
            ? a
            : s.unstable_useMutableSource,
        M =
          null !== (l = s.useSyncExternalStore) && void 0 !== l
            ? l
            : s.unstable_useSyncExternalStore,
        U = !1;
      var I = {
      ...
      var Y = {
          ...
          registerNode: function (e) {
            ...
            N.RECOIL_DUPLICATE_ATOM_KEY_CHECKING_ENABLED &&
              ((t = e.key),
              K.has(t) &&
                console.warn(`Duplicate atom key "${t}". This is a FATAL ERROR in
      production. But it is safe to ignore this warning if it occurred because of
      hot module replacement.`)),
              K.set(e.key, e);
            let n =
              null == e.set
                ? new x.RecoilValueReadOnly(e.key)
                : new x.RecoilState(e.key);
          ...
          deleteNodeConfigIfPossible: function (e) {
            var t, n;
            if (!L("recoil_memory_managament_2020")) return;
            let r = K.get(e);
            null != r &&
          ...
          setConfigDeletionHandler: function (e, t) {
            L("recoil_memory_managament_2020") &&
              (void 0 === t ? q.delete(e) : q.set(e, t));
          },
          getConfigDeletionHandler: Z,
          recoilValuesForKeys: function (e) {
            return z(e, (e) => h(j.get(e)));
          },
          NodeMissingError: H,
          DefaultValue: W,
          DEFAULT_VALUE: $,
          ...
          ((function (e) {
            var t =
              ...
              d = function (e, t, n, r) {
                ...
                for (var a = 0, l = 0, s = Array(o + 1); a < t; )
                  s[l++] = r[a++];
              ...
              m = function (e, t, n, r, o) {
                for (var i = [], a = r, l = 0, s = 0; a; ++s)
                  1 & a && (i[s] = o[l++]), (a >>>= 1);
                return (i[t] = n), y(e, l + 1, i);
              },
              S = function (e, t, n, r) {
                for (
                  var o = Array(t - 1), i = 0, a = 0, l = 0, s = r.length;
                  l < s;
                  ++l
                )
                  if (l !== n) {
              ...
              g = function e(t, n, r, o, i, s) {
                ...
                return _(
                  t,
                  l(u) | l(c),
                  u === c ? [e(t, n + 5, r, o, i, s)] : u < c ? [o, s] : [s, o]
                );
              },
              ...
              b = function (e, t, n, o, i, a, l) {
                ...
                return u === r
                  ? this
                  : (++l.value, g(e, n, this.hash, this, i, p(e, i, a, u)));
              },
              ...
              A = function (e, t, n, r, o, i, p) {
                ...
                if (w && h(E)) {
                  ...
                  if (
                    S.length <= 2 &&
                    ((v = S[1 ^ b]) === f || 1 === v.type || 2 === v.type)
                  )
                    return S[1 ^ b];
                  k = c(N, b, S);
                } else if (w || h(E)) k = u(N, b, E, S);
                else {
                  if (S.length >= 16) return m(e, g, E, y, S);
                  (L |= R), (k = d(N, b, E, S));
                }
                return N
                  ? ((this.mask = L), (this.children = k), this)
                  : _(e, L, k);
              },
              E = function (e, t, n, r, o, i, l) {
                ...
                return _
                  ? ((this.size = s), (this.children = m), this)
                  : y(e, s, m);
              };
            ...
            (f._modify = function (e, t, n, o, i, a, l) {
              ...
              (N.prototype.setTree = function (e, t) {
                return this._editable
                  ...
                  : e === this._root
                  ? this
                  : new N(this._editable, this._edit, this._config, e, t);
              });
            var L = (n.tryGetHash = function (e, t, n, r) {
              for (var o = r._root, i = 0, u = r._config.keyEq; ; )
                switch (o.type) {
                  ...
                  case 2:
                    if (t === o.hash)
                      for (
                        var c = o.children, d = 0, f = c.length;
                        d < f;
                        ++d
                      ) {
                        var h = c[d];
            ...
            (n.make = function (e) {
              return new N(
                0,
                0,
                { keyEq: (e && e.keyEq) || U, hash: (e && e.hash) || i },
                f,
                0
              );
            }),
      ...
      function ee(e) {
        return L("recoil_hamt_2020") ? new Q(e) : new X(e);
      }
      var et = Object.freeze({
          __proto__: null,
          persistentMap: { persistentMap: ee }.persistentMap,
        }),
        en = function (e, ...t) {
          let n = new Set();
          e: for (let r of e) {
      ...
      function eo(e, t, n, r) {
        ...
        if (!a || !r || a === r.nodeDeps.get(e)) {
          for (let n of (o.set(e, t), null == a ? t : en(t, a)))
            i.has(n) || i.set(n, new Set()), h(i.get(n)).add(e);
          if (a)
            for (let n of en(a, t)) {
              if (!i.has(n)) return;
              let t = h(i.get(n));
          ...
          r === u.currentTree.version ||
            ...
            r ===
              (null === (i = u.previousTree) || void 0 === i
                ? void 0
                : i.version) ||
            k("Tried to save dependencies to a discarded tree");
          let c = n.getGraph(r);
          if (
            (eo(e, t, c),
            r ===
              (null === (a = u.previousTree) || void 0 === a
                ? void 0
                : a.version) && eo(e, t, n.getGraph(u.currentTree.version), c),
            r ===
      ...
      function eN(e, t, n, r) {
        ...
        let i = eg(n),
          a = (function (e, t, n) {
            if (!L("recoil_memory_managament_2020")) return () => void 0;
      ...
      function ek(e, t, n) {
        ...
        for (let e = o.pop(); e; e = o.pop()) {
          ...
          null !== (a = i.nodeToNodeSubscriptions.get(e)) && void 0 !== a
            ? a
            : eA))
            r.has(t) || o.push(t);
        }
      ...
      var eV = {
        ...
        setNodeValue: function (e, t, n, r) {
          let o = eg(n);
          if (null == o.set)
            throw new eE(`Attempt to set read-only RecoilValue: ${n}`);
          let i = o.set;
          ...
          return eS(
            { type: i },
            {
              ...
              subscribers: () => {
                var o, i;
                return {
                  nodes: eT(em(ek(e, t, new Set([n])), (e) => e !== n)),
                  components: z(
                    null !==
                      (o =
                        null === (i = r.nodeToComponentSubscriptions.get(n)) ||
                        void 0 === i
                          ? void 0
                          : i.values()) && void 0 !== o
                      ? o
      ...
      function ej(e, t, n) {
        "hasValue" === n.state && n.contents instanceof ex
      ...
      var eQ = {
          ...
          getRecoilValueAsLoadable: function (
            ...
            n.version === i.currentTree.version ||
              n.version ===
                (null === (r = i.nextTree) || void 0 === r
                  ? void 0
                  : r.version) ||
              n.version ===
                (null === (o = i.previousTree) || void 0 === o
                  ? void 0
                  : o.version) ||
              k("Tried to read from a discarded tree");
            let a = eI(e, n, t);
          ...
          subscribeToRecoilValue: function (e, { key: t }, n, r = null) {
            ...
            i.nodeToComponentSubscriptions.has(t) ||
              ...
              h(i.nodeToComponentSubscriptions.get(t)).set(o, [
            ...
            if (
              a.early &&
              ("LEGACY" === a.mode || "MUTABLE_SOURCE" === a.mode)
            ) {
          ...
          applyAtomValueWrites: function (e, t) {
            ...
            return (
              t.forEach((e, t) => {
                "hasValue" === e.state && e.contents instanceof ex
                  ? n.delete(t)
                  : n.set(t, e);
              }),
              n
          ...
          batchStart: function () {
            ...
            return (
              ...
              () => {
                ...
                eZ.pop() !== e && k("Incorrect order of batch popping");
              }
            );
          },
      ...
      function e8(e, t) {
        ...
        for (let t of (function (e, t) {
          ...
          return (
            (function t(l) {
              ...
              for (let t of (function (e, t, n, r, o) {
                ...
                if (
                  "recoilRoot" === e5(t).retainedBy ||
                  (null !== (s = n.retention.referenceCounts.get(t)) &&
                  void 0 !== s
                    ? s
                    : 0) > 0 ||
                  e9(t).some((e) => n.retention.referenceCounts.get(e))
                ) {
                  a.add(t);
                  continue;
                }
              ...
              let d = new Set();
              for (let e of c)
                for (let t of null !== (u = o.nodeDeps.get(e)) && void 0 !== u
                  ? u
                  : e3)
                  i.has(t) || d.add(t);
              d.size && t(d);
          ...
          !(function (e, t, n) {
            ...
            e1(e, n);
            let i = e.getState();
            for (let e of (i.knownAtoms.delete(n),
            i.knownSelectors.delete(n),
            i.nodeTransactionSubscriptions.delete(n),
            i.retention.referenceCounts.delete(n),
            e9(n)))
            ...
            if (a) {
              ...
              if (void 0 !== e)
                for (let t of (a.nodeDeps.delete(n), e))
                  null === (o = a.nodeToNodeSubscriptions.get(t)) ||
                    void 0 === o ||
                    o.delete(n);
      ...
      var e7 = {
        ...
        releaseScheduledRetainablesNow: function (e) {
          if (!L("recoil_memory_managament_2020")) return;
          let t = e.getState();
          e8(e, t.retention.retainablesToCheckForRelease),
      ...
      let { batchUpdates: tu } = ti,
        { initializeNode: tc, peekNodeInfo: td } = eV,
        { graph: tf } = ei,
        { getNextStoreID: th } = eu,
        { DEFAULT_VALUE: tp, recoilValues: tv, recoilValuesForKeys: t_ } = Y,
        {
        ...
        { updateRetainCount: tR } = e7,
        { setInvalidateMemoizedSnapshot: tT } = eM,
        { getNextTreeStateVersion: tb, makeEmptyStoreState: tw } = ep,
        { isSSR: tA } = ts,
      ...
      class tN {
        constructor(e, t) {
          ...
          p(
            this,
            "getLoadable",
            (e) => (this.checkRefCount_INTERNAL(), tm(this._store, e))
          ),
          p(
            this,
            "getPromise",
          ...
          p(this, "getNodes_UNSTABLE", (e) => {
            if (
              ...
              return (null == e ? void 0 : e.isInitialized) === !1
                ? []
                : t_(this._store.getState().currentTree.dirtyAtoms);
            ...
            return (null == e ? void 0 : e.isInitialized) == null
              ...
              : !0 === e.isInitialized
              ? t_(ta([t, n]))
              : em(tv.values(), ({ key: e }) => !t.has(e) && !n.has(e));
          }),
          p(
            this,
            "getInfo_UNSTABLE",
            ({ key: e }) => (
              this.checkRefCount_INTERNAL(),
              td(this._store, this._store.getState().currentTree, e)
            )
          ),
          p(this, "map", (e) => {
            this.checkRefCount_INTERNAL();
          ...
          this._store.getState().knownAtoms))
            tc(this._store, n, "get"), tR(this._store, n, 1);
          this.autoRelease_INTERNAL();
        }
        retain() {
          this._refCount <= 0 &&
            k("Attempt to retain() Snapshot that was already released."),
            this._refCount++;
          let e = !1;
          return () => {
            e || ((e = !0), this._release());
        ...
        checkRefCount_INTERNAL() {
          L("recoil_memory_managament_2020") && this._refCount;
        }
        getStore_INTERNAL() {
      ...
      function tL(e, t, n = !1) {
        ...
        return {
          ...
          nodeCleanupFunctions: new Map(
            z(r.nodeCleanupFunctions.entries(), ([e]) => [e, () => {}])
          ),
        };
      }
      let [tk, tV] = tE(
      ...
      var tM = {
          ...
          cloneSnapshot: function (e, t = "latest") {
            let n = tk(e, t);
            return n.isRetained() ? n : (tV(), tk(e, t));
          },
        },
        tU = Object.freeze({
          __proto__: null,
      ...
      let { getNextTreeStateVersion: tO, makeEmptyStoreState: tP } = ep,
        {
          cleanUpNode: tx,
          getDownstreamNodes: tF,
          initializeNode: tz,
          setNodeValue: tG,
        ...
        { graph: t$ } = ei,
        { cloneGraph: tK } = ei,
        { getNextStoreID: tj } = eu,
        { createMutableSource: tH, reactMode: tq } = I,
        { applyAtomValueWrites: tZ } = eQ,
        { releaseScheduledRetainablesNow: tY } = e7,
        { freshSnapshot: tJ } = tU,
        {
          useCallback: tX,
          useContext: tQ,
      ...
      let t3 = Object.freeze({
          ...
          replaceState: t4,
          getGraph: t4,
          subscribeToTransactions: t4,
          addTransactionMetadata: t4,
        }),
        t8 = !1;
      function t9(e) {
        if (t8)
        ...
        if (null === t.nextTree) {
          L("recoil_memory_managament_2020") &&
            L("recoil_release_on_cascading_update_killswitch_2021") &&
            t.commitDepth > 0 &&
            tY(e);
      ...
      let t6 = s.createContext({ current: t3 }),
        t7 = () => tQ(t6),
        ne = s.createContext(null);
      function nt(e, t, n) {
        for (let r of tF(e, n, n.dirtyAtoms)) {
          let e = t.nodeToComponentSubscriptions.get(r);
          if (e) for (let [t, [r, o]] of e) o(n);
        }
      }
      function nn(e) {
        let t = e.getState(),
        ...
        if (r.size) {
          for (let [n, o] of t.nodeTransactionSubscriptions)
            if (r.has(n)) for (let [t, n] of o) n(e);
          for (let [n, r] of t.transactionSubscriptions) r(e);
          (!tq().early || t.suspendedComponentResolvers.size > 0) &&
            (nt(e, t, n),
      ...
      function nr({ setNotifyBatcherOfChange: e }) {
        let t = t7(),
          [, n] = t5([]);
        return (
          e(() => n({})),
            ...
            (function (e) {
              ...
              try {
                ...
                (t.previousTree = t.currentTree),
                  ...
                  (t.previousTree = null),
                  L("recoil_memory_managament_2020") && null == n && tY(e);
              } finally {
                t.commitDepth--;
              }
            })(t.current);
      ...
      function ni({
        ...
        let i = (e) => {
          ...
          l = (e) => {
            for (let t of (t9(f.current), Object.keys(e)))
              h(f.current.getState().nextTree).transactionMetadata[t] = e[t];
          },
          u = (e) => {
            let t;
            t9(f.current);
            ...
            t !== n &&
              ...
              tq().early && nt(f.current, o.current, t),
              h(c.current)());
          },
          c = t2(null),
          d = tX(
        ...
        let p = t1(
          () =>
            null == tH ? void 0 : tH(o, () => o.current.currentTree.version),
          [
            (o = tD(() =>
              null != e
                ? (function (e, t) {
        ...
        return (
          t0(() => {
            let e = f.current;
            for (let t of new Set(e.getState().knownAtoms)) tz(e, t, "get");
            return () => {
          ...
          s.createElement(
            ...
            s.createElement(
              ne.Provider,
              { value: p },
              s.createElement(nr, { setNotifyBatcherOfChange: d }),
              r
            )
          )
        );
      ...
      var na = {
          RecoilRoot: function (e) {
            let { override: t, ...n } = e,
              r = t7();
            return !1 === t && r.current !== t3
              ? e.children
              : s.createElement(ni, n);
          },
          useStoreRef: t7,
      ...
      let { useStoreRef: nd } = na,
        { SUSPENSE_TIMEOUT_MS: nf } = e7,
        { updateRetainCount: nh } = e7,
        { RetentionZone: np } = e_,
        { useEffect: nv, useRef: n_ } = s,
        { isSSR: ny } = ts;
      var nm = function (e) {
          if (L("recoil_memory_managament_2020"))
            return (function (e) {
              let t = (Array.isArray(e) ? e : [e]).map((e) =>
                  e instanceof np ? e : e.key
                ),
                n = nd();
              nv(() => {
                if (!L("recoil_memory_managament_2020")) return;
      ...
      let { batchUpdates: ng } = ti,
        ...
        { useRecoilMutableSource: nE, useStoreRef: nN } = na,
        { isRecoilValue: nL } = x,
        {
          AbstractRecoilValue: nk,
      ...
      function nG(e) {
        let t = nN(),
          ...
          r = nI(() => {
            ...
            return {
              loadable: nV(
                r,
                e,
                nb().early && null !== (n = o.nextTree) && void 0 !== n
                  ? n
                  : o.currentTree
              ),
              key: e.key,
          ...
          i = nD(() => o(r), [r, o]);
        return nA(
          nI((r) => nU(t.current, e, r, n).release, [t, e, n]),
          i,
          i
        ).loadable;
      }
          ...
          i = nI(
            (r, i) =>
              nU(
                ...
                e,
                () => {
                  if (!L("recoil_suppress_rerender_in_callback")) return i();
                  let e = n();
      ...
      function n$(e) {
        let t = nN(),
          ...
          o = nI(() => ({ loadable: r(), key: e.key }), [r, e.key]),
          i = nI(
            (e) => {
              let t = o();
          ...
          nB(() => {
            let i = t.current,
              ...
              s = nU(
                ...
                (e) => {
                  var t;
                  if (!L("recoil_suppress_rerender_in_callback")) return n([]);
                  let r = o();
      ...
      function nj(e) {
        return (
          L("recoil_memory_managament_2020") && nm(e),
          {
      ...
      function nZ(e) {
        return L("recoil_memory_managament_2020") && nm(e), n$(e);
      }
      function nY(e) {
        let t = nN();
        return nz(nZ(e), e, t);
      ...
      let { batchUpdates: n0 } = ti,
        { DEFAULT_VALUE: n1, getNode: n2, nodes: n5 } = Y,
        { useStoreRef: n4 } = na,
        { AbstractRecoilValue: n3, setRecoilValueLoadable: n8 } = eQ,
        { SUSPENSE_TIMEOUT_MS: n9 } = e7,
        { cloneSnapshot: n6 } = tU,
        { useCallback: n7, useEffect: re, useRef: rt, useState: rn } = s,
        { isSSR: rr } = ts;
      function ro(e) {
        let t = n4();
            ...
            for (let t of e) {
              ...
              (null === (r = o.atomValues.get(t)) || void 0 === r
                ...
                (null === (a = i.atomValues.get(t)) || void 0 === a
                  ? void 0
                  : a.contents) &&
                n2(t).shouldRestoreFromSnapshots &&
                n.add(t);
            }
          n.forEach((t) => {
            n8(e, new n3(t), i.atomValues.has(t) ? h(i.atomValues.get(t)) : n1);
          }),
        ...
        useRecoilSnapshot: function () {
          ...
          if (
            ...
            if (o.current) {
              ...
              window.clearTimeout(o.current),
                (o.current = null),
                null === (a = i.current) || void 0 === a || a.call(i),
                (i.current = null);
            }
            (i.current = t.retain()),
      ...
      let { peekNodeInfo: rs } = eV,
        { useStoreRef: ru } = na,
        { reactMode: rc } = I,
        { RecoilRoot: rd, useStoreRef: rf } = na,
        { useMemo: rh } = s,
        { loadableWithValue: rp } = E,
        { initializeNode: rv } = eV,
        { DEFAULT_VALUE: r_, getNode: ry } = Y,
        {
          copyTreeState: rm,
      ...
      let { atomicUpdater: rE } = rw,
        { batchUpdates: rN } = ti,
        { DEFAULT_VALUE: rL } = Y,
        { useStoreRef: rk } = na,
        { refreshRecoilValue: rV, setRecoilValue: rC } = eQ,
        { cloneSnapshot: rM } = tU,
        { gotoSnapshot: rU } = rl,
        { useCallback: rI } = s;
      class rB {}
      ...
      var rj = Object.freeze({
        __proto__: null,
        WrappedValue: { WrappedValue: rK }.WrappedValue,
      });
          ...
          let r = () => {
            ...
            for (let [t, r] of e) {
              ...
              if (
                "branch" !==
                  (c =
                    null !== (l = c = o ? o.branches.get(d) : e) && void 0 !== l
                      ? l
                      : {
                          type: "branch",
                          nodeKey: t,
              ...
              null == o || o.branches.set(d, c),
                null == n ||
                  null === (s = n.onNodeVisit) ||
                  void 0 === s ||
                  s.call(n, c),
                (d = this._mapNodeValue(r)),
                (this._root =
                  null !== (u = this._root) && void 0 !== u ? u : c);
            }
            let f = c
              ? null === (r = c) || void 0 === r
                ? void 0
      ...
      var rY = Object.freeze({
        __proto__: null,
        TreeCache: { TreeCache: rZ }.TreeCache,
      });
      class rJ {
        constructor(e) {
          var t;
      ...
      var rX = Object.freeze({
        __proto__: null,
        LRUCache: { LRUCache: rJ }.LRUCache,
      });
      let { LRUCache: rQ } = rX,
        { TreeCache: r0 } = rY;
      var r1 = function ({ name: e, maxSize: t, mapNodeValue: n = (e) => e }) {
          let r = new rQ({ maxSize: t }),
            o = new r0({
              name: e,
              mapNodeValue: n,
              onHit: (e) => {
        ...
        r2 = function (e, t = { allowFunctions: !1 }) {
          return (function e(t, n, r) {
            ...
            switch (typeof t) {
              ...
              case "function":
                if ((null == n ? void 0 : n.allowFunctions) !== !0)
                  throw d(
            ...
            if (Array.isArray(t))
              return `[${t.map((t, r) => e(t, n, r.toString()))}]`;
            ...
            return t instanceof Set
              ? e(
                  Array.from(t).sort((t, r) => e(t, n).localeCompare(e(r, n))),
                  n,
                  r
                )
              : void 0 !== Symbol &&
              ...
              : `{${Object.keys(t)
                  .filter((e) => void 0 !== t[e])
                  .sort()
                  .map((r) => `${e(r, n)}:${e(t[r], n, r)}`)
                  .join(",")}}`;
          })(e, t);
        };
      let { TreeCache: r5 } = rY,
        r4 = { equality: "reference", eviction: "keep-all", maxSize: 1 / 0 },
        { isReactNative: r3, isWindow: r8 } = ts,
        {
          isLoadable: r9,
      ...
      function og(e) {
        let t = null,
          ...
          l = (function (
            {
              equality: e = r4.equality,
              eviction: t = r4.eviction,
              maxSize: n = r4.maxSize,
            } = r4,
            r
          ) {
            return (function (e, t, n, r) {
              switch (e) {
                case "keep-all":
                  return new r5({ name: r, mapNodeValue: n });
                case "lru":
                  return r1({ name: r, maxSize: h(t), mapNodeValue: n });
                case "most-recent":
                  return r1({ name: r, maxSize: 1, mapNodeValue: n });
              }
          ...
          c = 0;
        function p() {
          return !L("recoil_memory_managament_2020") || c > 0;
        }
        function v(e) {
          return (
          ...
          return t
            .then((r) => {
              ...
              if (a && "loading" !== a.state) {
                if (
                  ((N(e, o) || null == A(e)) && y(e, o), "hasValue" === a.state)
                )
                  return a.contents;
                throw a.contents;
              }
        ...
        function R(e, t, r, o) {
          ...
          for (let h of ((N(e, o) ||
            t.version ===
              (null === (i = e.getState()) || void 0 === i
                ? void 0
                : null === (l = i.currentTree) || void 0 === l
                ? void 0
                : l.version) ||
            t.version ===
              (null === (s = e.getState()) || void 0 === s
                ? void 0
                : null === (u = s.nextTree) || void 0 === u
                ? void 0
                : u.version)) &&
            oi(
              n,
          ...
          function b({ key: t }) {
            ...
            switch (
              ...
              !u &&
                ...
                N(e, i) && (h(A(e)).stateVersions.clear(), m(i, !1))),
              n.state)
            ) {
              case "hasValue":
                return n.contents;
              ...
              case "loading":
                throw (
                  ((S.loadingDepKey = t),
                  (S.loadingDepPromise = n.contents),
                  n.contents)
                );
            }
            ...
            ((a = r({
              ...
              getCallback:
                ...
                (...r) => {
                  ...
                  return null != t || rA(!1), oh(e, n, r, { node: t });
                },
            })),
            (a = oc(a) ? b(a) : a),
            r9(a) && ("hasError" === a.state && (_ = !0), (a = a.contents)),
            f(a))
              ? (a = a
                  .then((t) => {
                    if (!p()) throw (E(e), o_);
        ...
        function b(e, t) {
          ...
          try {
            r = l.get(
              (n) => ("string" != typeof n && rA(!1), on(e, t, n).contents),
              {
                onNodeVisit: (e) => {
            ...
            throw d(
              `Problem with cache lookup for selector "${n}": ${e.message}`
            );
          }
          if (r) {
            var i;
            t.atomValues.set(n, r),
              R(
                ...
                t,
                o,
                null === (i = A(e)) || void 0 === i ? void 0 : i.executionID
              );
          }
          return r;
        }
        function w(e, t) {
          for (let n of ta([
            ...
            if (
              n.stateVersions.get(t.version) ||
              !(function (n) {
                for (let [r, o] of n) if (!on(e, t, r).is(o)) return !0;
                return !1;
              })(n.depValuesDiscoveredSoFarDuringAsyncWork)
            )
              return n.stateVersions.set(t.version, !0), n;
        ...
        function N(e, t) {
          var n;
          return (
            t === (null === (n = A(e)) || void 0 === n ? void 0 : n.executionID)
          );
        }
        function V(e, t, r) {
          ...
          try {
            ...
            throw d(
              `Problem with setting cache for selector "${n}": ${e.message}`
            );
          }
        }
        function C(e, t) {
          ...
          return null != r
            ...
            : l.get((n) => {
                var r;
                return (
                  "string" != typeof n && rA(!1),
                  null === (r = or(e, t, n)) || void 0 === r
                    ? void 0
                    : r.contents
                );
              });
        ...
        function M(e, t) {
          return (function (e) {
            if (oy.includes(n))
              return r6(
                d(
                  `Recoil selector has circular dependencies: ${oy
                    .slice(oy.indexOf(n))
                    .join(" → ")}`
                )
              );
            ...
            (function (e, t) {
              ...
              if (null != o)
                return (
                  (null === (n = o.loadingLoadable) || void 0 === n
                    ? void 0
                    : n.state) === "loading" && S(e, o.executionID),
                  o.loadingLoadable
                );
              let i = oS(),
                [a, l] = T(e, t, i);
          ...
          ? (function (e) {
              let t = ox({
                    ...
                    void 0 === e.persistence_UNSTABLE
                      ...
                      : {
                          ...
                          validator: (t) =>
                            t instanceof oL
                              ? t
                              : h(e.persistence_UNSTABLE).validator(t, oN),
                        },
                  effects: e.effects,
                ...
                n = og({
                  ...
                  get: ({ get: n }) => {
                    let r = n(t);
                    return r instanceof oL ? e.default : r;
                  },
                  set: ({ set: e }, n) => e(t, n),
                  cachePolicy_UNSTABLE: { eviction: "most-recent" },
                  dangerouslyAllowMutability: e.dangerouslyAllowMutability,
                });
              return oC(n.key, ok(e.key)), n;
            })({ ...t, default: n })
          : (function (e) {
              var t;
              let n;
              ...
              function c(e, t) {
                ...
                return null !==
                  (o =
                    null !== (i = t.atomValues.get(r)) && void 0 !== i
                      ? i
                      : n) && void 0 !== o
                  ? o
                  : s;
                ...
                get: function (e, t) {
                  ...
                  if (!t.nonvalidatedAtoms.has(r)) return s;
                  {
                    ...
                    let e = t.nonvalidatedAtoms.get(r),
                      i = o.validator(e, oN);
                    return (n = i instanceof oL ? s : ow(i));
                  }
                },
                set: function (e, t, o) {
                  if (t.atomValues.has(r)) {
                    let e = h(t.atomValues.get(r));
                    if ("hasValue" === e.state && o === e.contents)
                      return new Map();
                  } else if (!t.nonvalidatedAtoms.has(r) && o instanceof oL)
                    return new Map();
                  ...
                  a++,
                    ...
                    "loading" === s.state &&
                      s.contents.finally(() => {
                        ...
                        ).atomValues.has(r) || oI(t, p);
                      });
                  let v =
                    null !== (i = e.effects) && void 0 !== i
                      ? i
                      : e.effects_UNSTABLE;
                  if (null != v) {
                    let e = oN,
                    ...
                    function m(n) {
                      ...
                      let a = oE(
                        t,
                        null !== (o = t.getState().nextTree) && void 0 !== o
                          ? o
                          : t.getState().currentTree,
                        n.key
                      );
                      return !i || n.key !== r || e instanceof oL
                        ? a
                        : { ...a, isSet: !0, loadable: _(n) };
                    }
                    let g = (n) => (r) => {
                        if (i) {
                          let t = _(p),
                            o = "hasValue" === t.state ? t.contents : oN;
                          f((e = "function" == typeof r ? r(o) : r)) &&
                            (e = e.then(
                              (e) => ((S = { effect: n, value: e }), e)
                            ));
                        } else {
                          if (f(r))
                            throw d(
                      ...
                      T = (e) => (n) => {
                        ...
                        let { release: i } = t.subscribeToTransactions((t) => {
                          var o, i, a, l, u;
                          let { currentTree: c, previousTree: d } =
                            t.getState();
                          d ||
                            (k(
                            ...
                            (d = c));
                          let f =
                            null !== (o = c.atomValues.get(r)) && void 0 !== o
                              ? o
                              : s;
                          if ("hasValue" === f.state) {
                            let t = f.contents,
                              o =
                                null !== (i = d.atomValues.get(r)) &&
                                void 0 !== i
                                  ? i
                                  : s,
                    ...
                    if (((i = !1), !(e instanceof oL))) {
                      let o = a
                                ...
                                .then((t) => {
                                  ...
                                  return (
                                    (null ===
                                      ...
                                      ).atomValues.get(r)) || void 0 === i
                                      ? void 0
                                      : i.contents) === n && oB(e, p, t),
                                    t
                                  );
                                })
                                .catch((t) => {
                        ...
                        : ow(oP(e));
                      o.contents,
                        n.atomValues.set(r, o),
                        null === (h = t.getState().nextTree) ||
                          void 0 === h ||
                          h.atomValues.set(r, o);
                    }
                  }
                  return () => {
                    var e;
      ...
      var oz = Object.freeze({
        __proto__: null,
        MapCache: { MapCache: oF }.MapCache,
      });
      let { LRUCache: oG } = rX,
        { MapCache: oW } = oz,
        o$ = { equality: "reference", eviction: "none", maxSize: 1 / 0 };
      var oK = function ({
        ...
        return (function (e, t, n) {
          switch (e) {
            ...
            case "lru":
              return new oG({ mapKey: n, maxSize: h(t) });
            case "most-recent":
              return new oG({ mapKey: n, maxSize: 1 });
          }
          throw d(`Unrecognized eviction policy ${e}`);
        })(
          t,
      ...
      let { setConfigDeletionHandler: oj } = Y,
        { setConfigDeletionHandler: oH } = Y,
        oq = 0;
      var oZ = function (e) {
        var t, n;
        let r = oK({
        ...
        return (t) => {
          ...
          if (null != o) return o;
          let a = `${e.key}__selectorFamily/${
              null !== (n = r2(t, { allowFunctions: !0 })) && void 0 !== n
                ? n
                : "void"
            }/${oq++}`,
            l = (n) => e.get(t)(n),
      ...
      function o3(e, t, n) {
        return o4(
          e,
          n.map((e, n) => (null == e ? o0(t[n]) : f(e) ? oQ(e) : oX(e)))
        );
      }
      let o8 = oZ({
          key: "__waitForNone",
        ...
        o6 = oZ({
          ...
          get:
            ...
            ({ get: t }) => {
              let [n, r] = o1(t, o5(e));
              if (r.every((e) => null == e)) return o4(e, n);
              let o = r.find(o2);
              if (null != o) throw o;
              return Promise.all(r).then((t) =>
                o4(
                  e,
                  t.map((e, t) => (void 0 === e ? n[t] : e))
                )
              );
            },
          dangerouslyAllowMutability: !0,
        ...
        { RecoilLoadable: it } = E,
        { DefaultValue: ir } = Y,
        { RecoilRoot: io, useRecoilStoreID: ii } = na,
        { isRecoilValue: ia } = x,
        { retentionZone: il } = e_,
        { freshSnapshot: is } = tU,
        {
              ...
              nB(() => {
                ...
                return (
                  en(r.current, new Set(n.keys())).forEach((r) => {
                    let o = nU(t.current, new nk(r), (e) => l(e, r), e);
                    n.set(r, o);
                  }),
                  () => n.forEach((e, t) => a(t))
                );
            ...
            return (t, n = {}) => {
              ng(() => {
                e.current.addTransactionMetadata(n),
                  t.forEach((t, n) => nM(e.current, new nk(n), t));
              });
            };
          },
      ...
      var iL = {
          ...
          useRecoilBridgeAcrossReactRoots_UNSTABLE: function () {
            ...
            return rh(
              () =>
                function ({ children: t }) {
                  return s.createElement(rd, { store_INTERNAL: e }, t);
                },
              [e]
            );
          },
        ...
        ik = iL.DefaultValue,
        iV = iL.isRecoilValue,
        iC = iL.RecoilLoadable,
        iM = iL.RecoilEnv,
        iU = iL.RecoilRoot,
        iI = iL.useRecoilStoreID,
        iB = iL.useRecoilBridgeAcrossReactRoots_UNSTABLE,
        iD = iL.atom,
        iO = iL.selector,
        iP = iL.atomFamily,
        ix = iL.selectorFamily,
        iF = iL.constSelector,
        iz = iL.errorSelector,
        iG = iL.readOnlySelector,
        iW = iL.noWait,
        i$ = iL.waitForNone,
        iK = iL.waitForAny,
        ij = iL.waitForAll,
        iH = iL.waitForAllSettled,
        iq = iL.useRecoilValue,
        iZ = iL.useRecoilValueLoadable,
        iY = iL.useRecoilState,
        iJ = iL.useRecoilStateLoadable,
        iX = iL.useSetRecoilState,
        iQ = iL.useResetRecoilState,
        i0 = iL.useGetRecoilValueInfo_UNSTABLE,
        i1 = iL.useRecoilRefresher_UNSTABLE,
        i2 = iL.useRecoilValueLoadable_TRANSITION_SUPPORT_UNSTABLE,
        i5 = iL.useRecoilValue_TRANSITION_SUPPORT_UNSTABLE,
        i4 = iL.useRecoilState_TRANSITION_SUPPORT_UNSTABLE,
        i3 = iL.useRecoilCallback,
        i8 = iL.useRecoilTransaction_UNSTABLE,
        i9 = iL.useGotoRecoilSnapshot,
        i6 = iL.useRecoilSnapshot,
        i7 = iL.useRecoilTransactionObserver_UNSTABLE,
        ae = iL.snapshot_UNSTABLE,
        at = iL.useRetain,
        an = iL.retentionZone;
      t.default = iL;
    },
